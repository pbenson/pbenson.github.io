...
\begin{problem}
You are standing in a vast flat desert, one mile from the nearest road, which runs in a straight line.  You can't see the road until you are right on top of it. What is your strategy for finding the road with minimum hiking in the worst case?
\end{problem}
