...
\begin{problem}
Alex and Beth take turns flipping a pair of coins. Once either person flips a pair of heads, the game is over. Alex flips first. Beth wins. What is the probability she flipped a pair of heads on her second turn?
\end{problem}

\begin{problem}
Hanxi flips a fair coin 11 times, and Chen flips the coin 10 times. How likely is it that Hanxi flipped more heads?
\end{problem}

\begin{problem}
A friend offers to play the following game with you. Starting with a standard deck of 52 cards, you take turns drawing two cards. If the two cards are black, your friend keeps them. If they cards are red, you keep them. Otherwise, they are discarded. When the cards are gone, you and your friend combine your cards, shuffle them, and resume. At the end, if you end up with more cards than your friend, you win \$100. What is a fair price to pay to play this game?
\end{problem}
